...
public class AzureClientTests {
    ...
    //  Call the provided Utilities.testValidBase64Image() method to check that the returned string appears to be a valid image.
    //  Call the provided Utilities.saveBase64Image() to save a copy of your image.
